...
#
df = pd.read_excel(r'D:\filepath\2014-2019 WE2.xlsx')
data = df[['BGA']]
...
#WORKING
#
df = pd.read_excel(r'D:\filepath\2014-2018 WE2.xlsx')
#data = df[['Chl','BGA']]
data = df[['BGA']]
...
# Test OneClass SVM
df = pd.read_excel(r'D:\filepath\WE2 2019.xlsx')
#data = df[['Chl','BGA']]
data = df[['BGA']]
...
# Define datasets
df1 = pd.read_excel(r'D:\filepath\2014-2019 WE2.xlsx')
datasets = [
    df1[['Chl','BGA']]]
...
df2 = pd.read_excel(r'D:\filepath\2014-2019 WE2.xlsx')
...
df1 = pd.read_excel(r'D:\filepath\2015-2019 WE13.xlsx')
datasets = [
    df1[['Chl','BGA']]]

df2 = pd.read_excel(r'D:\filepath\2014-2019 WE4.xlsx')
